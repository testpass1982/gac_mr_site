"""
Django settings for ac_gacmr_site project.
...
# ALLOWED_HOSTS = ['ac_gacmr_site.minml.ru']
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'ac_gacmr_site.urls'
...
WSGI_APPLICATION = 'ac_gacmr_site.wsgi.application'
